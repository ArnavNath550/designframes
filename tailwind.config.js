...
module.exports = {
  ...
  theme: {
    ...
    backgroundImage: {
      ...
      'warm-gradient': 
        'radial-gradient(ellipse at center,rgba(194,97,254,0.15),transparent)',
      'warmer-gradient': 
        'radial-gradient(ellipse 100% 40% at 50% 60%,rgba(194,97,254,0.1),transparent)'
    },
    boxShadow: {
    ...
    fontFamily: {
      sans: '"Work Sans", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif',
    },
    fontSize: {
      xs: '1.3rem',
      sm: '1.4rem',
